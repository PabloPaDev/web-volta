...
export function Community() {
  ...
  return (
    <section id="community" className="py-20 md:py-24 bg-background">
      <div className="max-w-7xl mx-auto px-0">
        <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <CarouselContent className="-ml-0">
                {slides.map((slide, index) => (
                  <CarouselItem key={slide.src} className="pl-0 md:basis-full">
                    <div className="relative h-96 md:h-[32rem] rounded-xl overflow-hidden shadow-2xl shadow-black/30 group">
                      <Image
                        src={slide.src}
                        alt={slide.alt}
                        fill
          ...
          <ScrollReveal className="order-1 md:order-2 space-y-6" delay={220}>
            ...
            >
              <Button
                size="lg"
                className="w-fit rounded-full bg-[#DFAE67] px-8 text-[#2A1A12] transition-all duration-250 hover:bg-[#C8964A] hover:scale-105 active:scale-95 shadow-md hover:shadow-lg"
              >
                Únete Ahora
              </Button>
            </Link>
